...
public class DataInit {
    ...
    public void makeBasePosts() {
        ...
        postFacade.write(user1Member, "제목1", "내용1");
        postFacade.write(user1Member, "제목2", "내용2");
        postFacade.write(user1Member, "제목3", "내용3");
        postFacade.write(user2Member, "제목4", "내용4");
        postFacade.write(user2Member, "제목5", "내용5");
        postFacade.write(user3Member, "제목6", "내용6");
    }
